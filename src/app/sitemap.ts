...
const routes: { url: string; priority: number; freq: Freq }[] = [
  ...
  // Destinations
  { url: "/egypt",                           priority: 0.90, freq: "weekly"  },
  ...
  { url: "/vietnam",                         priority: 0.80, freq: "weekly"  },
  ...
  { url: "/visa/india",                      priority: 0.80, freq: "weekly"  },
  { url: "/visa/thailand",                   priority: 0.80, freq: "weekly"  },
  { url: "/visa/china",                      priority: 0.80, freq: "weekly"  },
  { url: "/visa/maldives",                   priority: 0.76, freq: "monthly" },
  // Uzbekistan Tours
  { url: "/uzbekistan-tours",                priority: 0.94, freq: "weekly"  },
  { url: "/uzbekistan-tours/samarkand",      priority: 0.90, freq: "weekly"  },
  { url: "/uzbekistan-tours/bukhara",        priority: 0.90, freq: "weekly"  },
  ...
  // New pages
  { url: "/contacts",                        priority: 0.95, freq: "monthly" },
  { url: "/about",                           priority: 0.85, freq: "monthly" },
  { url: "/reviews",                         priority: 0.88, freq: "weekly"  },
  { url: "/dubai/visa",                      priority: 0.82, freq: "monthly" },
  { url: "/hot-tours",                       priority: 0.95, freq: "daily"   },
  { url: "/directions",                      priority: 0.92, freq: "weekly"  },
