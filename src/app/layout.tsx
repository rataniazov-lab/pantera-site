...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${SITE_URL}/opengraph_image.png`,
        width: 1200,
        height: 630,
        alt: "PANTERA LUXE — Туры из Ташкента",
      },
    ],
  },
  twitter: {
    ...
    title: "PANTERA LUXE — Туры из Ташкента",
    description: "Туры в Дубай, Турцию, Египет, Мальдивы из Ташкента.",
    images: [`${SITE_URL}/opengraph_image.png`],
  },
  robots: {
    index: true,
    follow: true,
  ...
  icons: {
    icon: [
      {
        url: "https://res.cloudinary.com/dass5gqvk/image/upload/v1779576708/favicon_a6vpnj.ico",
        sizes: "any",
      },
      {
        url: "https://res.cloudinary.com/dass5gqvk/image/upload/v1779576719/icon_fsztwb.png",
        type: "image/png",
        sizes: "32x32",
      },
    ],
    apple: [
      {
        url: "https://res.cloudinary.com/dass5gqvk/image/upload/v1779576701/apple-icon_hgfowj.png",
        sizes: "180x180",
        type: "image/png",
      },
    ],
      ...
      <div className="footer-inner">
        <div className="footer-grid">
          ...
          <div className="f-col">
            ...
            <ul>
              <li>
                <a href="tel:+998771618888">+998 77 161 88 88</a>
              </li>
              <li>
                <a href="mailto:uz@exploremore.travel">uz@exploremore.travel</a>
              </li>
              <li>
                <a
                  href="https://t.me/vilet_support"
                  target="_blank"
              ...
              <li>
                <a
                  href="https://www.instagram.com/tury_tashkent/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="footer-ig-link"
                >
