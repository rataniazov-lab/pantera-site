...
const DESTS_PREVIEW = [
  ...
  { key:"turkey",  flag:"🇹🇷", title:"Турция",          sub:"Стамбул, Каппадокия, Анталья — два континента",      img:"https://res.cloudinary.com/dass5gqvk/image/upload/v1779480535/t1_dq4kvx.png", tags:["🏙️ Стамбул","🏖️ Анталья","🎈 Каппадокия","от $350"] },
];
